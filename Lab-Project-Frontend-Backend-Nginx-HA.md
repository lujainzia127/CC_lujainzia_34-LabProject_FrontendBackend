# 🧪 Lab Project – Terraform + Ansible: High-Availability Web Infrastructure
...
├── locals.tf                    # Local values (your IP)
...
└── ansible/
    ...
    └── roles/
        ...
        │   ├── tasks/
        │   │   └── main.yml     # Install & configure HTTPD
        │   ├── handlers/
        │   │   └── main.yml     # Service restart handlers
        │   └── templates/
        │       └── backend_index.html.j2  # Custom backend page
        │
        └── frontend/            # Frontend role
            ...
            │   └── main.yml     # Service restart handlers
            └── templates/
                └── nginx_frontend.conf.j2  # Nginx config with upstream
```
...
1. ✅ Creates VPC, subnet, internet gateway, route tables
2. ✅ Creates security groups (SSH from your IP, HTTP from anywhere)
3. ✅ Launches 4 EC2 instances (1 frontend + 3 backends)
4. ✅ Generates Ansible inventory with instance IPs
5. ✅ Waits 60 seconds for instances to be ready
6. ✅ Runs Ansible playbooks to configure all servers
7. ✅ Installs Nginx on frontend with load balancer config
8. ✅ Installs Apache HTTPD on all backends with custom pages
